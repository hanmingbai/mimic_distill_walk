...
class DAggerPPO:
    ...
    def __init__(
        ...
        # --- [改动 1: 初始化迭代次数统计] ---
        self.current_iter = 0
        self.max_iters = 20000 # 占位符，由 runner 动态设置 ---------------------------------------------- 人为设置
    ...
    def construct_algorithm(obs: TensorDict, env: VecEnv, cfg: dict, device: str) -> DAggerPPO:
        ...
        alg: DAggerPPO = alg_class(actor, critic, storage, teacher=teacher, device=device, **cfg["algorithm"], multi_gpu_cfg=cfg["multi_gpu"])
        return alg

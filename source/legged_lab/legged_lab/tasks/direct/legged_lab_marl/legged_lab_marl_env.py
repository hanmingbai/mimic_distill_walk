...
from .legged_lab_marl_env_cfg import LeggedLabMarlEnvCfg


class LeggedLabMarlEnv(DirectMARLEnv):
    cfg: LeggedLabMarlEnvCfg

    def __init__(self, cfg: LeggedLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
